...
import { Building2, MessageSquare, Settings, LogOut, ChevronRight, Users, Menu, X, Tag, Pencil, Scissors } from 'lucide-react'
...
export default function Sidebar({ appUser }: Props) {
  ...
  const navItems = [
    ...
    { href: '/admin/discounts',   icon: Scissors,      label: '할인규정',      show: isAdmin },
